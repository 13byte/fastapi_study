...
def get_notes(
    ...
    return {"total_couint": total_count, "page": page, "items_per_page": items_per_page}
...
def get_note(
    ...
    note: Note = note_service.get_note(user_id=current_user.id, id=id)
...
def delete_note(
    id: str,
    current_user: Annotated[CurrentUser, Depends(get_current_suer)],
    note_service: NoteService = Depends(Provide[COntaienr.note_service]),
):
